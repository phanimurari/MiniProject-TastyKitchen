...
class LoginForm extends Component {
  ...
  renderDesktopLoginLandingImage = () => (
    <div className="login-page-desktop-landing-page-container"> </div>
  )

  renderMobileLoginLandingImage = () => (
    <div className="login-page-mobile-landing-page-container">
      <img src="https://res.cloudinary.com/imphanimurari/image/upload/v1635180628/Mini%20Projects/Tasty%20Kitchen/Rectangle_1457_1_yuhpck.png" />
    </div>
  )

  renderLoginFormContainer = () => (
    <div className="login-form-container">
      {this.renderMobileLoginLandingImage()}
